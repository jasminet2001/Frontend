<template>
  ...
  >
    ...
    >
      ...
      <v-list-item link @click="EditProf()">
        <v-list-item-icon>
      ...
      <v-list-item link @click="submitAds()">
        <v-list-item-icon>
...
label .menu {
  ...
  box-shadow: 0 0 0 0 #3751FF, 0 0 0 0 #3751FF;
  cursor: pointer;
}
...
label input:checked + .menu {
  box-shadow: 0 0 0 100vw #3751FF, 0 0 0 100vh #3751FF;
  border-radius: 0;
}
